...
#[AsCommand(
    name: 'app:insert-3000-employees',
    description: 'Insert 3000 additional employees using fast SQL approach',
)]
class Insert3000EmployeesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Insertion de 3000 Employés Supplémentaires');
