...
#[AsCommand(
    name: 'app:insert-2000-fast',
    description: 'Insert 2000 employees using fast SQL approach',
)]
class Insert2000FastCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Insertion Rapide de 2000 Employés');
