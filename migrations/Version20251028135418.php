...
final class Version20251028135418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Indexes for t_user table
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_employe_roles ON t_user((roles::text))');
        ...
        // Indexes for t_usere_contrat table
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_employee_contrat_user_id ON t_usere_contrat(employe_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_employee_contrat_nature_contrat_id ON t_usere_contrat(nature_contrat_id)');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_employee_contrat_statut ON t_usere_contrat(statut)');
        ...
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_org_employee_contrat_usere_contrat_id ON t_organisation_employee_contrat(employee_contrat_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IF EXISTS idx_employee_contrat_user_id');
        ...
        $this->addSql('DROP INDEX IF EXISTS idx_org_employee_contrat_usere_contrat_id');
